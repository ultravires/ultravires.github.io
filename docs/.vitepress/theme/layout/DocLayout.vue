...
<template>
  ...
  <div class="container mx-auto py-12">
    <article id="article" class="dark:bg-neutral-900 dark:border-neutral-800 dark:prose-pre:border-neutral-800 dark:prose-invert prose-pre:border prose-pre:border-solid prose-pre:border-neutral-200 prose-code:px-2 prose-code:py-1 prose-code:bg-primary prose-code:bg-opacity-10 prose-code:text-primary prose-code:rounded-md prose-blockquote:not-italic prose-blockquote:font-normal md:prose-lg max-md:px-6 max-sm:px-4 lg:prose-xl prose prose-neutral prose-lg max-w-none p-12 mx-auto bg-white rounded-md border border-solid border-neutral-200">
