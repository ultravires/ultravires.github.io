...
<template>
  ...
  >
    ...
    >
      <div
        class="dark:bg-neutral-900 flex items-center gap-2 p-2 mt-3 bg-white/90 border border-solid border-primary rounded-full text-normal tracking-wide cursor-default backdrop-blur-md"
      >
        <VLink
