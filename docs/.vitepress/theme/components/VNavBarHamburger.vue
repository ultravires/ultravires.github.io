...
<template>
  <div class="flex items-center">
    ...
    <div v-if="isShow" class="dark:border-neutral-800 dark:bg-neutral-900 container fixed mx-auto bg-white border-t border-solid border-neutral-200 top-[calc(60px+1px)]  left-0 right-0 bottom-0 z-10">
